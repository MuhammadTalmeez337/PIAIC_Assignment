...
def function3():
    ...
    x = a[(a%7 ==0) & (a%5==0)] #wrtie your code here
    return x
    """
    Expected Output:
...
def function11():
    ...
    ans = (arr%2 == 1) #write your code here 
    arr[ans] = -1
    print(arr)
    return ans
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans1 = np.repeat(arr,3)#write your code here 
    ans2 = np.tile(arr,3)
...
def function18():
    ...
    x = np.in1d(students, piaic) # Write you code Here
